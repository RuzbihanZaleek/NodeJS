// 1. Need below 4 common core modules
...
const server = http.createServer((req, res) => {
    ...
    // //In this case we habe to consider all requesting urls
...
// 4. Listen to the server once the server starts
